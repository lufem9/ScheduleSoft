...
<div class="navbar">
    ...
    <a href="newclientinfojsp.jsp">Register Client</a>
    <a href="newentityinfojsp.jsp">Register Entity</a>
    <!--<a href="#">Link</a>
    <a href="#">Link</a>-->
</div>
...
<div class="row">
    <div class="side">
        ...
        <form>
            <table class="box">
                <tr>
                    <td> Welcome to Schedule soft application</td>
                </tr>
                <tr>
                    <td>Manage all your schedule appointment at one stop</td>
                </tr>
                </br>
                <tr>
