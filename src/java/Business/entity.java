...
public class entity
{
    ...
    public void insertDB( String id, String na, String em, int ph, String add)
    {
        ...
        String sqlQuery = "INSERT into Business.entity values('" + getId() +"',"
                + "'" + getName() +"',"
                + "'" + getEmail() +"',"
                + "" + getPhone() +","
                + "'" + getAddress() +"')";
    ...
    public void updateDB()
    {
        ...
        String sqlQuery =  "update Business.entity  set Entity_Name = "
                + "'" + getName() +"', "
                + "Email = '" + getEmail() +"',"
                + "Phone = " + getPhone() +", "
                + "Address = '" + getAddress() +"' " +
    ...
    public void deleteDB( ){
        ...
        String sqlQuery = "DELETE FROM Business.entity WHERE EId = "
                + "'" + getId() +"'";
